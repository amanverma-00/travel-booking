...
const MyPayments = () => {
  ...
  const fetchPayments = async () => {
    try {
      const response = await axios.get('/api/payments/user/my-payments', {
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Track all your booking payments and transactions</p>
          </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">${getTotalAmount('completed')}</p>
                </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">${getTotalAmount('pending')}</p>
                </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">${getTotalAmount('refunded')}</p>
                </div>
